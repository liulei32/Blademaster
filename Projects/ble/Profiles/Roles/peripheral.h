...
typedef enum
{
  ...
  GAPROLE_STARTED = 1,                        //!< Started but not advertising
  GAPROLE_ADVERTISING = 2,                    //!< Currently Advertising
  GAPROLE_WAITING = 3,                        //!< Device is started but not advertising, is in waiting period before advertising again
  GAPROLE_WAITING_AFTER_TIMEOUT = 4,          //!< Device just timed out from a connection but is not yet advertising, is in waiting period before advertising again
  GAPROLE_CONNECTED = 5,                      //!< In a connection
  GAPROLE_ERROR = 6                          //!< Error occurred - invalid state
} gaprole_States_t;
