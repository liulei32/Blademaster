...
// MyChar UUID: 0xFFF6
CONST uint8 mycharUUID[ATT_BT_UUID_SIZE] =
{ 
  0xf6, 0xff
};
...
// Simple Profile MyChar Properties
static uint8 myCharProps = GATT_PROP_READ | GATT_PROP_WRITE;

// MyChar Value
static uint8 myChar[MYCHAR_LEN];
static uint32 myNum = 0;

// Simple Profile MyChar User Description
static uint8 myCharUserDesp[8] = "Lei Liu\0";
...
static gattAttribute_t simpleProfileAttrTbl[SERVAPP_NUM_ATTR_SUPPORTED] = 
{
  ...
  { 
    { ATT_BT_UUID_SIZE, primaryServiceUUID }, /* type */// 2800
    ...
    { 
      ...
      { 
        { ATT_BT_UUID_SIZE, simpleProfilechar1UUID },//fff1
...
bStatus_t SimpleProfile_SetParameter( uint8 param, uint8 len, void *value )
{
  ...
  switch ( param )
  {
    ...
    case MYCHAR:
      ...
      {
         myNum = *((uint32*)value);
         myChar[0] = (uint8) (myNum&0x000000ff);
         myChar[1] = (uint8) ((myNum>>8)&0x000000ff);
         myChar[2] = (uint8) ((myNum>>16)&0x000000ff);
         myChar[3] = (uint8) ((myNum>>24)&0x000000ff);
      }
      else
      {
       ret = bleInvalidRange;
                            ...
                            uint8 *pValue, uint8 *pLen, uint16 offset, uint8 maxLen )
{
  ...
  if ( pAttr->type.len == ATT_BT_UUID_SIZE )
  {
    ...
    switch ( uuid )
    {
      ...
      case 0xfff6:  
        *pLen = MYCHAR_LEN;
        VOID osal_memcpy( pValue, pAttr->pValue, MYCHAR_LEN );
        break;
